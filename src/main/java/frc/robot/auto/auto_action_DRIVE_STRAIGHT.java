...
public class auto_action_DRIVE_STRAIGHT extends Command {
   ...
   * @param timeout
   */
  public auto_action_DRIVE_STRAIGHT(double distance, String gear, double targetSpeed, double targetAngle, double timeout) {
  ...
  public auto_action_DRIVE_STRAIGHT(double distance, String gear, double targetSpeed, double timeout) {
    this.targetDistance = distance;
    this.gear = gear;
    this.targetSpeed = targetSpeed;
    this.timeout = timeout;
    this.targetAngle = Robot.drivetrain.getGlobalGyro();
    // Use requires() here to declare subsystem dependencies
    requires(Robot.drivetrain);
  }
